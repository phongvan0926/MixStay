...
export default function CallFab({ phone = '0379838222', stacked = true }: Props) {
  const display = '0379 838 222';
  return (
    <a
      href={`tel:${phone}`}
    ...
    >
      ...
      <span className="hidden sm:inline whitespace-nowrap">Hotline {display}</span>
    </a>
  );
}
