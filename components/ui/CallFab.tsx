...
export default function CallFab({ phone = '0379838222', display, label = 'Hotline', showNumber = true, stacked = true }: Props) {
  ...
  return (
    <a
      ...
      className={`fixed z-50 right-4 ${stacked ? 'bottom-20 sm:bottom-[4.5rem]' : 'bottom-4'} inline-flex items-center gap-2 rounded-full bg-brand-700 text-white shadow-lg shadow-brand-900/30 transition-all hover:scale-105 hover:bg-brand-800 hover:shadow-xl active:scale-95
