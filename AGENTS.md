...
- **Hotline công ty:** KHÔNG chép cứng số điện thoại vào component/trang. Lấy từ `lib/contact.ts` (`SUPPORT_PHONE`, `SUPPORT_PHONE_DISPLAY`, `SUPPORT_ZALO`). Số cũ từng nằm rải rác 5 chỗ, đổi số phải đi lùng từng chỗ và suýt sót.
